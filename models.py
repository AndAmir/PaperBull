...
class STOCKS(DB.Model):
    stock_instance_id = DB.Column(DB.Integer, unique=True, nullable=False, primary_key=True)
    username_id = DB.Column(DB.Integer,DB.ForeignKey('USERS.username_id'), nullable=False)
...
class HISTORY(DB.Model):
    history_instance_id = DB.Column(DB.Integer, unique=True, nullable=False, primary_key=True)
    username_id = DB.Column(DB.Integer,DB.ForeignKey('USERS.username_id'), nullable=False)
